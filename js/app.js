        ...
        contentDiv.innerHTML = `
            <div class="coin-list">
                <div class="list-header">
                    <div class="col-rank sortable" data-sort-key="rank">순위 ${this.getSortArrow('rank')}</div>
                    <div class="col-coin sortable" data-sort-key="symbol">코인명 ${this.getSortArrow('symbol')}</div>
                    <div class="col-longshort sortable" data-sort-key="longAccount">롱/숏 ${this.getSortArrow('longAccount')}</div>
                    <div class="col-volume sortable" data-sort-key="volume">거래량 ${this.getSortArrow('volume')}</div>
                    <div class="col-change sortable" data-sort-key="priceChangePercent">변동률 ${this.getSortArrow('priceChangePercent')}</div>
